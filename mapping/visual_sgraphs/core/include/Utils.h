...
namespace ORB_SLAM3
{
    ...
    public:
         ...
         */
        static void clusterPlaneClouds(const pcl::PointCloud<pcl::PointXYZRGBA>::Ptr &cloud, std::vector<pcl::PointIndices> &clusterIndices, double tolerance);
        
        static double calculateMinimumDistance(const pcl::PointCloud<pcl::PointXYZRGBA>::ConstPtr& cloudA, const pcl::PointCloud<pcl::PointXYZRGBA>::ConstPtr& cloudB);
        /**
