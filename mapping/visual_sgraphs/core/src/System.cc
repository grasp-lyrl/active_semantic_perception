...
namespace ORB_SLAM3
{
    ...
    void System::addSegmentedImage(std::shared_ptr<std::tuple<pcl::PointCloud<pcl::PointXYZRGB>::Ptr, cv::Mat, pcl::PCLPointCloud2::Ptr, tf2::Transform, semantic_inference_msgs::DetectionResults::ConstPtr>> tuple)
    {
