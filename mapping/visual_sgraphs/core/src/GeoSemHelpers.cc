...
namespace ORB_SLAM3
{
    ORB_SLAM3::Plane *GeoSemHelpers::createMapPlane(Atlas *mpAtlas, Eigen::Matrix4d& eigen_cTw,
                                                    Eigen::Matrix4d& eigen_wTc,
                                                    ...
                                                    ORB_SLAM3::Plane::planeVariant semanticType, double confidence)
    {
        ...
        newMapPlane->addObservation(obs);
    ...
    void GeoSemHelpers::updateMapPlane(Atlas *mpAtlas, Eigen::Matrix4d& eigen_cTw,
                                       ...
                                       ORB_SLAM3::Plane::planeVariant semanticType, double confidence)
    {
        ...
        // the aggregated confidence of the plane
        obs.confidence = confidence;
        currentPlane->addObservation(obs);
